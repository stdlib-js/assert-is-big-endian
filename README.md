...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/assert-is-big-endian/tags). For example,

```javascript
IS_BIG_ENDIAN = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-big-endian@v0.1.0-umd/browser.js' )
```
